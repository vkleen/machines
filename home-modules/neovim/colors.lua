...
M.setup = function()
    ...
    M.highlight("DiffAdd", { fg = M.colors.black, bg = M.colors.diff_green })
    ...
    M.highlight("Normal", { fg = M.colors.white, bg = M.colors.dark_black })
    ...
    M.highlight("Search", { fg = M.colors.white, bg = M.colors.comment_grey })
    M.highlight("ESearchMatch", { fg = M.colors.white, bg = M.colors.comment_grey })
    ...
    M.highlight("IndentBlanklineContextChar", { fg = M.colors.dark_yellow, gui = "nocombine" })
    M.highlight("IndentBlanklineContextStart", { sp = M.colors.dark_yellow, gui = "underline" })
