...
let
  cfgFile = (pkgs.formats.yaml {}).generate "ejabberd.yaml" {
    ...
    certfiles = [
      "${config.security.acme.certs."ejabberd.kleen.org".directory}/key.pem"
      "${config.security.acme.certs."ejabberd.kleen.org".directory}/fullchain.pem"
      "${config.security.acme.certs."xmpp.kleen.org".directory}/key.pem"
      "${config.security.acme.certs."xmpp.kleen.org".directory}/fullchain.pem"
      "${config.security.acme.certs."pubsub.xmpp.kleen.org".directory}/key.pem"
      "${config.security.acme.certs."pubsub.xmpp.kleen.org".directory}/fullchain.pem"
      "${config.security.acme.certs."proxy.xmpp.kleen.org".directory}/key.pem"
      "${config.security.acme.certs."proxy.xmpp.kleen.org".directory}/fullchain.pem"
      "${config.security.acme.certs."muc.xmpp.kleen.org".directory}/key.pem"
      "${config.security.acme.certs."muc.xmpp.kleen.org".directory}/fullchain.pem"
    ];
    listen = [
      { port = 5222;
        ip = "::";
...
in {
  ...
  security.acme.certs = {
    "ejabberd.kleen.org".group = "ejabberd";
    "xmpp.kleen.org".group = "ejabberd";
    "pubsub.xmpp.kleen.org".group = "ejabberd";
    "proxy.xmpp.kleen.org".group = "ejabberd";
    "muc.xmpp.kleen.org".group = "ejabberd";
  };
  ...
  users.groups."xmpp" = {};
  age.secrets."ejabberd-config-secrets".file = ./ejabberd-config-secrets.age;
