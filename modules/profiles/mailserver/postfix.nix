    ...
    services.uucp = {
      ...
      sshUser = {
        openssh.authorizedKeys.keys = [
          ''
            no-port-forwarding,no-X11-forwarding,no-agent-forwarding,command="${pkgs.uucp config.security.wrapperDir}/bin/uucico" ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFzPd3YvC0XZoH1QtPYkBTUUO0+lJCnM6Ey947rDoka7 root@seaborgium
          ''
        ];
      };
      interval = null;
